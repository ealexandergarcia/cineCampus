...
const seatsRoutes = require('./server/routes/seatsRoutes'); // Importa las rutas de películas
...
app.use('/asientos', seatsRoutes); // Usa las rutas de autenticación en la API
